...
class GuardGui(tk.Tk):
    ...
    def open_log(self) -> None:
        ...
        try:
            compat.open_path_or_url(str(LOG_PATH))
        except Exception as exc:
            self._append_log(f"Open log failed: {exc}\n")

    def open_readme(self) -> None:
        try:
            compat.open_path_or_url(str(README_PATH))
        except Exception as exc:
            self._append_log(f"Open README failed: {exc}\n")
